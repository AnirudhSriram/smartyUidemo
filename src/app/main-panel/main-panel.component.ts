...
export class MainPanelComponent implements OnInit {
  ...
  Options2 = {
    ...
    title: {
      text: `Energy Production in Region 2`
    },
    xAxis: {
      type: 'datetime',
      alignTicks: true,
  ...
  Options4 = {
    ...
    title: {
      text: `Energy Production in Region 4`
    },
    xAxis: {
      type: 'datetime',
      alignTicks: true,
  ...
  Options3 = {
    ...
    title: {
      text: `Energy Production in Region 3`
    },
    xAxis: {
      type: 'datetime',
      alignTicks: true,
  ...
  Options1 = {
    ...
    title: {
      text: `Energy Production in Region 1`
    },
    xAxis: {
      type: 'datetime',
      alignTicks: true,
  ...
  chartsList=["",this.Options1,this.Options2,this.Options3,this.Options4];
